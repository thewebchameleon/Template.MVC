CREATE TABLE [dbo].[Role_Claim] (
    ...
    [Is_Deleted]   BIT      CONSTRAINT [DF_Role_Claim_Is_Deleted] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [UC_Role_Claim__Claim_Id_Role_Id] UNIQUE NONCLUSTERED ([Claim_Id] ASC, [Role_Id] ASC)
);
